/*****************************************************************************
* Filename:          Y:\Custom_IP\MyProcessorIPLib/drivers/lcd_ip_v1_00_a/src/lcd_ip_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the lcd_ip driver
...
XStatus LCD_IP_SelfTest(void * baseaddr_p)
{
  ...
  LCD_IP_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LCD_IP_mReadSlaveReg0(baseaddr, 0);
